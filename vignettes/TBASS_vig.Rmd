...
where $\theta'$ represents the candidate model parameters and $\theta$ represents the current model parameters, $\pi$ is the likelihood multiplied by the prior, and $S$ is the proposal to jump from one model to another. 
